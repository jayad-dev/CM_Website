...
export interface ApiFeaturedInitiativeFeaturedInitiative
  ...
  info: {
    displayName: 'FeaturedInitiative';
    pluralName: 'featured-initiatives';
    singularName: 'featured-initiative';
  };
  options: {
  ...
  attributes: {
    ...
    imageGrid1: Schema.Attribute.Component<'layout.card-component', false>;
    imageGrid2: Schema.Attribute.Component<'layout.card-component', false>;
    imageGrid3: Schema.Attribute.Component<'layout.card-component', false>;
    imageGrid4: Schema.Attribute.Component<'layout.card-component', false>;
    imageGrid5: Schema.Attribute.Component<'layout.card-component', false>;
    imageGrid6: Schema.Attribute.Component<'layout.card-component', false>;
    imageGrid7: Schema.Attribute.Component<'layout.card-component', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::featured-initiative.featured-initiative'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomePageBannerHomePageBanner
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    stripBanner: Schema.Attribute.Component<'strip-banner.strip-baneer', false>;
...
export interface ApiHomePageCardHomePageCard extends Struct.SingleTypeSchema {
  collectionName: 'home_page_cards';
  info: {
    displayName: 'HomePageCard';
    pluralName: 'home-page-cards';
    singularName: 'home-page-card';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    Block1: Schema.Attribute.Component<'layout.card-component', false>;
    Block2: Schema.Attribute.Component<'layout.card-component', false>;
    Block3: Schema.Attribute.Component<'layout.card-component', false>;
    Block4: Schema.Attribute.Component<'layout.card-component', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Heading: Schema.Attribute.String;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-page-card.home-page-card'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Subheading: Schema.Attribute.Text;
